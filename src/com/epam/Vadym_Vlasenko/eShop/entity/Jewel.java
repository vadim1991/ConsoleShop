...
public abstract class Jewel extends Product {
	...
	@Parameter(parameter = "material", parameterType = "enum")
	...
	@Parameter(parameter = "title", parameterType = "String")
	...
	@Parameter(parameter = "description", parameterType = "String")
	...
	@Parameter(parameter = "weight", parameterType = "double")
